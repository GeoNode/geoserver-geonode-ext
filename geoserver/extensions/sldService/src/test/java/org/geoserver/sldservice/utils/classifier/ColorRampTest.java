...
public class ColorRampTest extends GeoServerSystemTestSupport {
	...
	public void grayColorRampTest() throws Exception {
		...
		assertEquals("Incorrect value for last reverse color", new Color(minColorInt, minColorInt, minColorInt),
				reverseColors.get(9));
		assertEquals("Incorrect value for 1st reverse color", new Color(maxColorInt, maxColorInt, maxColorInt),
				reverseColors.get(0));
	}
